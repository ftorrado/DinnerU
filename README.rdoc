...
* ~~Use something like Zomato as an alternative to the current address location selector.~~
...
* Missing authorization rules for Orders, should have it even as embedded object?
